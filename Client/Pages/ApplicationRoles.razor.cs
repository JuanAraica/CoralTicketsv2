...
namespace CoralTickets.Client.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<CoralTickets.Server.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(CoralTickets.Server.Models.ApplicationRole role)
        {
            try
            {
