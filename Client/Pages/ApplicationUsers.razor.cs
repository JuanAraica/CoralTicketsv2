...
namespace CoralTickets.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<CoralTickets.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<CoralTickets.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(CoralTickets.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(CoralTickets.Server.Models.ApplicationUser user)
        {
            try
            {
